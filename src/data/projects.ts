export const projectsData = [
  ...
  {
    id: "sharedrop",
    title: "Share Drop UI/UX",
    subtitle: "Figma Design Concept",
    description: "A complete UI/UX design project for a file-sharing application focused on clean, intuitive user interfaces and seamless user experience.",
  ...
  },
  {
    ...
    title: "AI-Based Phishing Detection Tool",
    subtitle: "Security Tool (Entry Level)",
    description: "An entry-level security tool leveraging artificial intelligence to detect and prevent phishing attempts by analyzing URL structures and webpage content.",
